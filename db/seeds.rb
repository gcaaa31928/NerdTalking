...
Article.create(id: 0, title: 'Article0', desc: 'Desc0', url: 'Url0', date: Date.current, tags: ['learning', 'AI'], issue_id: 0, score: 2)
Article.create(title: 'Article1', desc: 'Desc1', url: 'Url1', date: Date.current, tags: ['learning', 'AI'], issue_id: 0)
